...
/**
 ***********************************************************************************************
 * DeclarationOfMembership preferences
 *
...
use Plugins\DeclarationOfMembership\classes\Presenter\DeclarationOfMembershipPreferencesPresenter;
use Plugins\DeclarationOfMembership\classes\Service\DeclarationOfMembershipPreferencesService;
...
try {
    ...
    switch ($getMode) {
        case 'html':
            ...
            $page = new DeclarationOfMembershipPreferencesPresenter($getPanel);
        ...
        case 'save':
            $preferences = new DeclarationOfMembershipPreferencesService();
        ...
        case 'html_form':
            $preferencesUI = new DeclarationOfMembershipPreferencesPresenter('adm_preferences_form');
            $methodName = 'create' . str_replace('_', '', ucwords($getPanel, '_')) . 'Form';
            echo $preferencesUI->{$methodName}();
            break;
    }
} catch (Throwable $exception) {
    if (in_array($getMode, array(
        'save'
    ))) {
        echo json_encode(array(
            'status' => 'error',
