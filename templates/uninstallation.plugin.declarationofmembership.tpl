<form {foreach $attributes as $attribute}
    ...
    <div class="card admidio-field-group">
        <div class="card-header">{$l10n->get('PLG_DECLARATION_OF_MEMBERSHIP_MENU_ITEM')}</div>
        <div class="card-body">   
    ...
    <div class="card admidio-field-group">
        <div class="card-header">{$l10n->get('PLG_DECLARATION_OF_MEMBERSHIP_CONFIG_DATA')}</div>
        <div class="card-body"> 
